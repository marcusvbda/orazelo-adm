...
export const TimelineMenu = () => {
  ...
  return (
    ...
    >
      <DropMenuItem
        onClick={() => router.push("/admin/profile/prefession-experience-edit")}
      >
        Editar
      </DropMenuItem>
...
export const ProfessionalExperiencesForm = ({ mode = "create" }: any) => {
  return (
    <>
  ...
  const items = useMemo(
    () => [
          ...
          <Modal
            ...
            source={
              <TimelineTitle
                ...
                description="Adicione uma nova experiência"
              />
            }
            title="Adicionar nova"
      ...
      },
      {
        ...
        title: (
          <TimelineTitle
            title="Entrou na Orazelo"
            description="12 de Julho de 2024"
          />
        ),
      },
      {
        ...
        title: (
          <TimelineTitle
            title="Psicóloga Especializada em Terapia Cognitivo-ComportamentalC"
            description={
              <>
                6 meses - Atualmente •{" "}
                <span className="text-primary">Clínica Paliotti</span>
              </>
            }
          />
        ),
